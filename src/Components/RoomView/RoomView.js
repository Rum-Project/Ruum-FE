          ...
          <div className="detailed-view-info">
            <div className="detailed-view-top-info">
              <div className="detailed-view-room-name-info">
                <div className="detailed-view-info-title">Jeff's House</div>
                <div className="detailed-view-specific-room-name">Main Auditorium</div>
              </div>
            ...
            <div className="detailed-view-middle-info">
              <div className="available-instruments-info">
                <div className="detailed-view-info-title">Available Instruments:</div>
                <div className="detailed-view-instruments-list">Piano, Drums, Kazoo, French Horn</div>
              </div>
              <div className="detailed-view-amenity-info">
                <div className="detailed-view-info-title">Amenities:</div>
                <div className="detailed-view-amenity-list">Bathroom, Wifi, AC/Heat, and More...</div>
              </div>
            </div>
